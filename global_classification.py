...
### Need to add the project root to the path if necessary
# home = os.path.expanduser('~')
# code_dir = os.path.join(home , 'emotiw18_group')k
...
######## Manually setting for debugging purpose
...
##############################################
    ...
    # prepares the output directory for saving models
    ...
    # This is an example fo how copy files back to my
    # computer after I run them in other computer
